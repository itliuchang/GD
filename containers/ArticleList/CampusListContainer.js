...
class CampusListContainer extends Component{
    constructor(props){
        super(props)
    }
    componentDidMount(){
        this.props.dispatch(fetchArticleList({pageNum: 1,type:'campus'}))
    }
    ...
    nextPage(){
        this.props.dispatch(fetchArticleList({pageNum:this.props.articleList.class.params.pageNum+1,type:'campus'}))
    }
    render(){
        const {
            data
            }=this.props.articleList.campus
        return <div>
